...
<AmazonCard asin="B0H5NCY1C8" fallbackTitle="Satechi USB-C Snap Hub をAmazonで見る" />
...
日本での入手性は改善した。2026年8月21日時点でSnap HubはAmazon.co.jpに正式掲載され、Citrusカラーの取り扱いを確認できる。一方でOntheGo 5-in-1とSlim EXマウスはAmazon.co.jpでの掲載を確認できておらず、こちらは引き続きSatechi公式サイトかAmazon.com（米国）が主な入手経路になる。Snap Hubも現時点で確認できるのはCitrusのみで、Blush・Indigo・Silverの国内展開は追って確認したい。
